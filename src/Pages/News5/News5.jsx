...
import img from "../News5/image/istockphoto-169969575-612x612.jpg";

const News5 = () => {
  return (
    <div>
      <NavLink to={"/"}>
        <button className="btn bg-red-300 fixed top-4 left-4 ">Back</button>
      </NavLink>
      <Header></Header>
      ...
      <div>
        ...
        <p className="p-4  text-justify">
          he world of entertainment is a dynamic and ever-evolving landscape
          ...
          The pandemic also had a significant impact on live events, with many
          concerts, festivals, and theater productions being canceled or
          ...
          in content and exploring new ways to engage audiences. The rise of
          virtual and augmented reality is also expected to play a significant
          role in the future of entertainment, offering immersive experiences
          that blur the lines between the physical and digital worlds. The
          gaming industry will likely continue its upward trajectory, driven by
          the growth of mobile and cloud gaming, as well as the expanding
          popularity of esports. Meanwhile, the film industry will need to adapt
          to the changing distribution landscape, finding new ways to balance
          theatrical releases with digital platforms. In the live entertainment
          sector, the focus will likely be on creating experiences that can’t be
          replicated online, whether through innovative performances,
          interactive elements, or immersive environments. The blending of live
          and virtual experiences will also continue to evolve, offering
          audiences more ways to engage with their favorite artists and
          performers. In conclusion, the world of entertainment is in a state of
          constant evolution, driven by technological innovation, changing
          audience preferences, and the ongoing impact of global events. As the
          industry continues to adapt and innovate, it will play an increasingly
          important role in shaping the cultural landscape of the future.
        </p>
      </div>
    </div>
  );
